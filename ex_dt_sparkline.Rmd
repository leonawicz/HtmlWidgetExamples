...
Inline graphs can be shown with calls in your `R` Markdown document in the form `r rinline("sparkline(dat_p)")`.
Different plots can be made by passing a `type` argument, e.g., `r rinline("sparkline(dat_p, type='bar')")`.
